...
public class RequetesJDBC {
    ...
    public RoleConnexion connexion(String login, String mdp) throws SQLException{
        PreparedStatement ps = laConnexion.prepareStatement("select * from UTILISATEURS natural join ROLES where pseudo = ? and mdp = ?");
	...
	public boolean inscription(String nom, String prenom, String pseudo, String mdp) throws SQLException{
		...
		PreparedStatement ps = laConnexion.prepareStatement("INSERT INTO `UTILISATEURS`(nom,prenom,pseudo,mdp, idRole) VALUES (?,?,?,?,?)");
		ps.setString(1, nom);
